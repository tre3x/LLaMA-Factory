...
#SBATCH --output="sbatch-logs/sft-lama3_8b-full"
#SBATCH --error="sbatch-logs/sft-lama3_8b-full"
...
export WANDB_PROJECT=llama3_8b_agthoughts
export WANDB_API_KEY=271886b31cddea20b12cb5a3c7cb95718a7c16c7
export PATH="$CONDA_PREFIX/bin:$PATH"
llamafactory-cli train examples/train_full/llama3_8b_agthoughts_full_sft.yaml
