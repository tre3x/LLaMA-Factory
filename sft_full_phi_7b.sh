...
#SBATCH --output="sbatch-logs/sft-qwen7b-full"
#SBATCH --error="sbatch-logs/sft-qwen7b-full"
...
llamafactory-cli train examples/train_full/phi3_7b_agthoughts_filtered_full_sft.yaml
